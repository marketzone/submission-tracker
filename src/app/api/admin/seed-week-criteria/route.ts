...
// ─────────────────────────────────────────────────────────────────────────────
// Pattern texts — verbatim from prisma/seed.ts (single source of truth).
// Both files must stay in sync. If you edit a pattern here, edit seed.ts too.
// ─────────────────────────────────────────────────────────────────────────────
...
// 16 rows — exactly mirrors prisma/seed.ts structure and launchStrategy values.
// Week 6: all four rows have launchStrategy = null (apply to all strategies).
// Week 5: P_W5_LIVE is shared by free_event and pwyw_or_low_ticket (two rows).
// Week 7: P_W7_LIVE is shared by free_event and pwyw_or_low_ticket (two rows).
const SEED_ROWS = [
  { weekNumber: 2, launchStrategy: "free_event",         deliverableName: "Launch Event Opt-in Page (AIDA)",              templateVariant: "aida",               templatePattern: P_W2_FREE_AIDA,    sourceDocUrl: null },
  { weekNumber: 2, launchStrategy: "free_event",         deliverableName: "Launch Event Opt-in Page (Storytelling)",      templateVariant: "storytelling",       templatePattern: P_W2_FREE_STORY,   sourceDocUrl: null },
  { weekNumber: 2, launchStrategy: "pwyw_or_low_ticket", deliverableName: "Launch Event Sales Page",                      templateVariant: null,                 templatePattern: P_W2_PWYW_SALES,   sourceDocUrl: null },
  { weekNumber: 2, launchStrategy: "evergreen",          deliverableName: "VSL Script",                                   templateVariant: null,                 templatePattern: P_W2_EVERGREEN_VSL, sourceDocUrl: null },
  { weekNumber: 3, launchStrategy: null,                 deliverableName: "Ad Copy Scripts (3 Angles)",                   templateVariant: "ad_copy",            templatePattern: P_W3_AD_COPY,      sourceDocUrl: null },
  { weekNumber: 3, launchStrategy: null,                 deliverableName: "Ad Video Script",                              templateVariant: "ad_video",           templatePattern: P_W3_AD_VIDEO,     sourceDocUrl: null },
  { weekNumber: 4, launchStrategy: null,                 deliverableName: "Core Program Offer",                           templateVariant: null,                 templatePattern: P_W4_CORE_OFFER,   sourceDocUrl: null },
  { weekNumber: 5, launchStrategy: "free_event",         deliverableName: "Pre-launch Email Sequence (Live/Scheduled)",   templateVariant: null,                 templatePattern: P_W5_LIVE,         sourceDocUrl: null },
  { weekNumber: 5, launchStrategy: "pwyw_or_low_ticket", deliverableName: "Pre-launch Email Sequence (Live/Scheduled)",   templateVariant: null,                 templatePattern: P_W5_LIVE,         sourceDocUrl: null },
  { weekNumber: 5, launchStrategy: "evergreen",          deliverableName: "Pre-launch Email Sequence (Evergreen)",        templateVariant: null,                 templatePattern: P_W5_EVERGREEN,    sourceDocUrl: null },
  { weekNumber: 6, launchStrategy: null,                 deliverableName: "Webinar / Workshop / Challenge Presentation",  templateVariant: null,                 templatePattern: P_W6_WEBINAR,      sourceDocUrl: null },
  { weekNumber: 6, launchStrategy: null,                 deliverableName: "Core-Offer Sales Page",                        templateVariant: "long_form",          templatePattern: P_W6_LONG_FORM,    sourceDocUrl: null },
  { weekNumber: 6, launchStrategy: null,                 deliverableName: "Core-Offer Sales Page",                        templateVariant: "desire_stack",       templatePattern: P_W6_DESIRE_STACK, sourceDocUrl: null },
  { weekNumber: 6, launchStrategy: null,                 deliverableName: "Core-Offer Sales Page",                        templateVariant: "three_step_even_if", templatePattern: P_W6_THREE_STEP,   sourceDocUrl: null },
  { weekNumber: 7, launchStrategy: "free_event",         deliverableName: "Post-Webinar Sales Email Sequence",            templateVariant: null,                 templatePattern: P_W7_LIVE,         sourceDocUrl: null },
  { weekNumber: 7, launchStrategy: "pwyw_or_low_ticket", deliverableName: "Post-Webinar Sales Email Sequence",            templateVariant: null,                 templatePattern: P_W7_LIVE,         sourceDocUrl: null },
]
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const aidaRow = await prisma.weekCriteria.findFirst({
      where: { weekNumber: 2, launchStrategy: "free_event", templateVariant: "aida" },
      select: { weekNumber: true, launchStrategy: true, templateVariant: true, deliverableName: true },
    })

    return NextResponse.json({ ok: true, rowsSeeded: count, expectedRows: 16, aidaSpotCheck: aidaRow })
  } catch (err) {
